...
export class FirebaseRecaptchaVerifierModal extends React.Component<Props, State> implements FirebaseAuthApplicationVerifier {
  static defaultProps = {
  ...
  cancel = () => {
    const { reject } = this.state;
    if (reject) {
      const err = new Error("Canceled by user") as CustomError;
